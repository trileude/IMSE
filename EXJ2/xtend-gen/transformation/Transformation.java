...
public class Transformation {
  ...
  public void tranform(final String pollSystemFile, final String mappingFile) {
    ...
    final MetaLayout ui = MmuiFactory.eINSTANCE.createMetaLayout();
    boolean _and = false;
    ...
    if (_and) {
      ...
      int flagPremierLayout = 1;
      Layout layoutCourant = ((Layout) null);
      Layout layoutOld = ((Layout) null);
      boolean _hasNext = itPollSystem.hasNext();
      boolean _while = _hasNext;
      while (_while) {
        {
          Layout _createLayout = MmuiFactory.eINSTANCE.createLayout();
          layoutCourant = _createLayout;
          ...
          if (_hasNext_1) {
            ...
            if (_notEquals_2) {
              ...
              boolean _notEquals_3 = (!Objects.equal(typeTrouve, null));
              if (_notEquals_3) {
                ...
                EList<ElementUI> _listeElementUI = layoutCourant.getListeElementUI();
                _listeElementUI.add(questionUI);
                courant = questionUI;
                layoutCourant.setFirstElement(questionUI);
              } else {
                ...
                EList<ElementUI> _listeElementUI_1 = layoutCourant.getListeElementUI();
                _listeElementUI_1.add(questionUI_1);
                courant = questionUI_1;
                layoutCourant.setFirstElement(questionUI_1);
              }
            } else {
            ...
            while (_while_1) {
              {
                ...
                if (_notEquals_4) {
                  ...
                  boolean _notEquals_5 = (!Objects.equal(typeTrouve_1, null));
                  if (_notEquals_5) {
                    ...
                    courant = _next_2;
                    EList<ElementUI> _listeElementUI_3 = layoutCourant.getListeElementUI();
                    ...
                    courant = _next_3;
                    EList<ElementUI> _listeElementUI_4 = layoutCourant.getListeElementUI();
                  ...
                  courant = _next_4;
                  EList<ElementUI> _listeElementUI_5 = layoutCourant.getListeElementUI();
            ...
            boolean _equals = (flagPremierLayout == 1);
            if (_equals) {
              flagPremierLayout = 0;
              EList<Layout> _listeLayout = ui.getListeLayout();
              _listeLayout.add(layoutCourant);
              ui.setFirstElement(layoutCourant);
              layoutOld = layoutCourant;
            } else {
              EList<Layout> _listeLayout_1 = ui.getListeLayout();
              _listeLayout_1.add(layoutCourant);
              layoutOld.setNext(layoutCourant);
              Layout _next_1 = layoutOld.getNext();
              layoutOld = _next_1;
            }
          }
        }
        boolean _hasNext_1 = itPollSystem.hasNext();
        _while = _hasNext_1;
      }
    }
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
